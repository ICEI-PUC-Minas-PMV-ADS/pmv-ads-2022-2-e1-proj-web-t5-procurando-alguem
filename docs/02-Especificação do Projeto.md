...
|                              | busca por pessoas desaparecidas.    | atualizada de pessoas que      |
|                              |                                     | desapareceram.                 |
|------------------------------|-------------------------------------|--------------------------------|
|                              | Fazer com que alguém que encontre   | Propiciar o encontro entre     |
|      Demetria Lovato         | uma pessoa desaparecida saiba quais | quem está procurando e         |
|                              | medidas tomar para que aqueles que  | quem está perdido, o mais      |
|                              | procuram por alguém sejam informados| rápido possível.               |
|------------------------------|-------------------------------------|--------------------------------|
|                              | Visualizar fotos e conhecer o perfil| Identificar o perfil de pessoas|
|      Christopher Catesby     | de pessoas que estão sendo          | desaparecidas na região onde   |
|         Harington            | procuradas.                         | trabalha tendo o objetivo de   |
|                              |                                     | elaborar um TCC sobre o tema:  | 
|                              |                                     | pessoas desaparecidas.         |
| -----------------------------|-------------------------------------|--------------------------------|                  
|      Christopher Catesby     | Saber onde e a quem contactar caso  | Conhecer esses ritos, para     |
|         Harington            | se depare com alguém perdido.       | entender e incluir no TCC.     |
|------------------------------|-------------------------------------|--------------------------------|
|                              | Saber localizar e nomear as         | Identificar, para poder incluir|
|     Christopher Catesby      | ferramentas disponíveis que podem   | no seu TCC, quais ferramentas  |    
|         Harington            | contribuir na localização de pessoas| estão disponíveis para a       |
|                              | desaparecidas.                      | localização de pessoas         |
|                              |                                     | desaparecidas.                 |
|------------------------------|-------------------------------------|--------------------------------|
|                              | Saber por onde começar a procurar a | Porque desconhece os ritos a   |
|     Candida Augusta          | pessoa desaparecida.                | serem seguidos e está com a    |
|                              |                                     | situação em que o seu marido,  |
|                              |                                     | com Alzheimer, fugiu de casa e |
|                              |                                     |ela não sabe qual conduta adotar|
|------------------------------|-------------------------------------|--------------------------------|
|                              | Encontrar ferramentas               | Está com o marido, portador de |
|     Candida Augusta          | disponibilizadas no entorno do      | Alzheimer desaparecido há 6    |  
|                              | domicílio de residência ou próximo  | horas e ficou sabendo da       |
|                              | ao local do desaparecimento.        | existência de um grupo de      |
|                              |                                     | WhatsApp do bairro onde reside.|
|------------------------------|-------------------------------------|--------------------------------|
|     Candida Augusta          | Inserir informações sobre as        | Para poder divulgar            |
|                              | características da pessoa           | informações gerais do marido   |
|                              | desaparecida.                       | e principalmente o problema    |
|                              |                                     | de saúde dele.                 |
|------------------------------|-------------------------------------|--------------------------------|
|                              | Conhecer os ritos oficiais para     |Já vivenciou uma situação em que| 
|   José da Silva Marques      |  procurar por alguém desaparecido.  | perdeu o pai no metrô por uma  |
|                              |                                     | hora e não sabia o que fazer.  |
|------------------------------|-------------------------------------|--------------------------------|
|                              | Entender as primeiras providências  | A fim de agilizar a busca e    |
|  José da Silva Marques       | a tomar em caso de desaparecimento  | consequentemente encontrar uma |
|                              | de alguém.                          | pessoa que tenha desaparecido. |  
|------------------------------|-------------------------------------|--------------------------------|
|                              | Ter um lugar para postar informações| Para poder encontrar seu pai   |
|  José da Silva Marques       |de seu pai em caso de desaparecimento| o mais rápido possível.        |
|                              | e uma mensagem seja enviada para as |                                |
|                              | pessoas que moram naquela cidade.   |                                |
|------------------------------|-------------------------------------|--------------------------------|
