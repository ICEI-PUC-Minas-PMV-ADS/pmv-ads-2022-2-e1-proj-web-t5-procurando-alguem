function menuPaginaAtual(ondeEstou){
    ...
    if(ondeEstou != "home-page"){
        conteudoHTML += `<li class="nav-item space-menu"><a class="nav-item" href="home-page.html">Home Page</a></li>`;
    }

    if(ondeEstou != "desaparecidos"){
        conteudoHTML += `<li class="nav-item space-menu"><a class="nav-item" href="desaparecidos.html">Desaparecidos</a></li>`;
    }

    if(ondeEstou != "encontrados"){
        conteudoHTML += `<li class="nav-item space-menu"><a class="nav-item" href="encontrados.html">Encontrados</a></li>`;
    }

    if(ondeEstou != "sobre"){
        conteudoHTML += `<li class="nav-item space-menu"><a class="nav-item" href="sobre.html">Sobre</a></li>`;
    }       
...
function ultimoItemMenu(){
    ...
    if (usuarioCorrente == null) {
        conteudoHTML += `<li class="nav-item dropdown menor-drop">`;
        conteudoHTML += `<img src="../../imagens/imagem-perfil.png" width="40" height="30"><br><a class="dropdown-item" id="loginMenu" href="login.html"> Login/<br>Cadastro</a></a>`;
        conteudoHTML += `</li>`;
        conteudoHTML += `</ul>`;  
    } else {
        conteudoHTML += `<li class="nav-item dropdown menor-drop">`;
        conteudoHTML += `<a class="nav-item dropdown-toggle menor-size" data-bs-toggle="dropdown" aria-expanded="false">`;
        ...
        conteudoHTML += `<li><a class="dropdown-item" href="chat-e-amigos.html">Chat e Amigos</a></li>`;
